...
echo "files given: 1)$user_input_dir 2)$user_output_directory 3)$user_jar"

hadoop fs -rm -r /user/indir
hadoop fs -mkdir /user/indir
hadoop fs -put $user_input_dir /user/indir
hadoop fs -rm -r /user/outdir*
hadoop jar $user_jar org.ProductDriver /user/indir /user/outdir /user/outdir1 /user/outdir2 /user/outdir3 /user/outdir4
